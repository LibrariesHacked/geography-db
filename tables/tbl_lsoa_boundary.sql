...
select AddGeometryColumn ('public', 'lsoa_boundary', 'geom_generalised', 27700, 'MULTIPOLYGON', 2);
...
create index idx_lsoaboundary_geomgeneralised on lsoa_boundary using gist (geom_generalised);
