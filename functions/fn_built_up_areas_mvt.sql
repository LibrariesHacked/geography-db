create or replace function fn_built_up_areas_mvt(x integer, y integer, z integer) returns bytea as
$$
declare
...
from (
  select buacd, buanm, st_asmvtgeom(st_transform(geom, 3857), tile_bbox, 4096, 256, true) as mvt_geom
  from built_up_area_boundary
